  ...
  return (
    <div className="fixed bottom-7 right-7 z-[9999] group">
      ...
      <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all pointer-events-none">
        <div className="bg-white text-brand-text px-4 py-2 rounded-full shadow-brand-hover text-[13px] font-sans font-medium whitespace-nowrap">
      ...
      <a 
        ...
        className="w-[60px] h-[60px] bg-brand-whatsapp rounded-full flex items-center justify-center text-white shadow-[0_4px_20px_rgba(34,197,94,0.45)] transition-transform hover:scale-110 whatsapp-pulse"
      >
        <svg 
          viewBox="0 0 24 24" 
          width="32" 
