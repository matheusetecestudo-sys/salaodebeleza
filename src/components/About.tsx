          ...
          <ScrollReveal direction="right">
            <div className="animate text-left">
              ...
              <h2 className="font-serif text-[38px] sm:text-[48px] md:text-[62px] leading-[1.05] font-bold text-brand-noir mb-8">
                Um estúdio projetado para quem exige resultados <span className="italic text-brand-primary font-normal">reais</span>.
              </h2>
              
              <div className="max-w-[600px]">
                <p className="font-sans text-[16px] md:text-[18px] leading-relaxed text-gray-600 font-light italic mb-12">
                  Entendemos que cada cliente é única. Nossa abordagem vai além de um simples corte ou coloração: realizamos um diagnóstico profundo dos seus fios e do seu formato de rosto. Entregamos uma consultoria de imagem completa com execução impecável para garantir a saúde e a sofisticação que você merece.
                </p>
