        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-12 mb-20 text-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-start lg:col-span-1">
            <a href="#" className="flex items-center mb-8 group text-center lg:text-left">
              <span className="relative font-serif text-[40px] font-black tracking-[0.05em] text-brand-primary transition-all duration-500">
                DUNO
              </span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#experiencia" className="font-sans text-[15px] text-brand-muted-on-noir hover:text-brand-primary hover:translate-x-1 inline-block transition-all duration-300">Experiência</a></li>
